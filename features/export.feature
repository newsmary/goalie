...
Scenario: Export scores
  ...
  And I have a team called "The Buzzards" with an objective to "Release the hounds" and a score of "20" given by "Peter" with a status of "In progress" and a reason of "Woof woof!"
  When I sign in as an administrator
  And I click on "Admin"
